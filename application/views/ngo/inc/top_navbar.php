        ...
        <div class="navbar-inner">
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="<?=base_url('ngo/')  ?>" class="navbar-brand" style="padding-top: 3px;">
                       <!--  <?php
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <!-- <li>
                                        <div class="avatar-area">
                                            ...
                                            <span class="caption">NGO</span>
                                        </div>
                                    </li> -->
                                    <li class="edit">
                                        <a href="<?=base_url('ngo/change_password')  ?>" class="pull-left">Change Password</a>
                                    </li>
                                   
                                    <li class="dropdown-footer">
                                        <a href="<?=base_url('ngo/logout')  ?>">
                                            Sign out
                                        </a>
                                    </li>
                                </ul>
