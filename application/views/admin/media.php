        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="well with-header">
                    <div class="header bordered-palegreen">Add Slider </div>
                    <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
                        <div class="form-group" style="padding:15px; clear:both;  min-height:300px;" id="foo">
                            ...
                            <div class="col-sm-9 col-md-9">
                                ...
                                <input type="text" maxlength="50" name="media_title" class="form-control" required>
                                <br/>

                                <label>Description* <small><em>(Max 100 Caharcter.)</em></small></label>
                                <textarea rows="4" type="text" maxlength="100" class="form-control" name="media_desc" required></textarea>
                                <br/>
