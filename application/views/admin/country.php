            ...
            <form id="validationform" data-parsley-validate="" novalidate="" method="post" role="form">
                <div class="container-fluid  dashboard-content">
                    ...
                    <div class="well with-header">
                        <div class="header bordered-palegreen">+Add Country </div>                
                        <br/>                        
                        <div class="row">
                            <div class="col-md-9">
                                <label>Country Name*</label>
                                 <input type="text" id="country_name" name="country_name" required placeholder="Type something"  class="form-control">

                                 <br/>
                                 <label>country Url*</label>
                                 <input type="text" name="country_utl" id="country_utl" required placeholder="Type something"  class="form-control">

                                 <br/>
                                 <label>Over View</label>
                                 <textarea required="" 
                                  name="overview"  class="form-control"></textarea>

                                 <br/>
                                 <label>Glance</label>
                                 <textarea required=""  name="glance_text"  class="form-control"></textarea>

                                 <br/>
                                 <label>Why Choose Us</label>
                                 <textarea required=""  name="why_text" class="form-control"></textarea>

                                 <br/>
                                 <label>Exams & Coaching</label>
                                 <textarea required=""  name="exam_text"
                                   class="form-control"></textarea>

                                 <br/>
                                 <label>Education Cost Info</label>
                                 <textarea required="" name="cost_text"  
                                 class="form-control"></textarea>
                                 <br/>
                                 <label>Other Essential Information</label>
                                 <textarea required="" 
                                  name="other_info"  class="form-control"></textarea>
                                 <br/>
