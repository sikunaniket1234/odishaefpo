                                    ...
                                    <form id="validationform" data-parsley-validate="" novalidate="" method="post" role="form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-10 col-lg-6">
                                                <input type="text" name="url"  required placeholder="Type something" class="form-control">
                                            </div>
                                        </div> 
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-2 col-form-label text-sm-right"> Meta Title*</label>
                                            <div class="col-12 col-sm-10 col-lg-6">
                                                <input type="text" name="title" required placeholder="Type something" class="form-control">
                                            </div>
                                        </div> 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10 col-sm-10 col-lg-10">
                                                <textarea type="text" name="meta_key" class="form-control"  ></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10 col-sm-10 col-lg-10">
                                                <textarea type="text" name="meta_otherinfo" class="form-control"  ></textarea>
                                            </div>
                                        </div>
