        ...
        <div class="row">                      
            ...
            <div class="col-md-12">
                ...
                <div class="well with-header">
                    <div class="header bordered-palegreen">Add <?=@$ext_hd ?> Category</div>
                    ...
                    <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="text" class="form-control" id="cat_nm" name="cat_nm" required>
                                        </div>
                                ...
                                <div class="form-group" style="padding-left:15px; background: #fcffe9; border-top:2px dashed #ccc; border-bottom:2px dashed #ccc; margin-left:0; width:99%;clear:both; display: none;  
