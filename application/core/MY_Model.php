...
class MY_Model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->_fetch_table();
         $this->db=$this->_database = $this->db;
    ...
    public function get($primary_value)
    {
		...
		//echo $this->_database->last_query();exit();
    }
    /**
   ...
   public function get_by()
    ...
    public function get_many_by()
    {
		...
		//$this->db->limit(2);
        $r=$this->get_all();
		//echo '<br>'.$this->_database->last_query();//exit();
        return $r;
    }
    /**
    ...
    public function get_all()
    {
        ...
        $r = $this->_database->get($this->_table);
        if($r) 	
        {
	        $result = $r->{$this->_return_type(1)}();
     ...
     */
    public function insert($data, $skip_validation = FALSE,$print = FALSE)
    {
    	//$print=TRUE;
     ...
     */
    public function insert_many($data, $skip_validation = FALSE, $print=FALSE)
    {
        $ids = array();
        foreach ($data as $key => $row)
        {
            ...
            if($print)
            	echo '<br>'.$this->_database->last_query();
        }
        return $ids;
    }
    /**
     ...
     */
    public function update($primary_value, $data, $skip_validation = FALSE, $print = FALSE)
    {
    ...
    protected function _return_type($multi = FALSE)
    {
      ...
      /**
      *  ODBUS Customized Function
      *  CREATE DATE : 09-10-2017 11:12 AM

      *  Change STATUS of a record

         Status = 0  --> Inactive/Block
         Status = 1  --> Pending
         Staus  = 2  --> Processing
         Status = 3  --> Active/Approved
         Status = 4  --> Trash  
         Status = 5  --> Permanently Delete
    */
